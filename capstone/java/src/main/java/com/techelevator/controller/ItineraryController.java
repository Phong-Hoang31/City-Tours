...
public class ItineraryController {
    ...
    public void createItinerary(@RequestBody ItineraryDTO itineraryDTO) {
        itineraryDao.createItinerary(itineraryDTO.getItinerary().getItineraryName(),
                itineraryDTO.getItinerary().getStartingPoint(),
                itineraryDTO.getItinerary().getItineraryDate(),
                itineraryDTO.getUser().getId());
    }
